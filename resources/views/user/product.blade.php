...
<body>
    ...
    <main class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="fs-5 py-4 text-center text-custom">
                        Check Ongkir
                    </h2>
                    <div class="card border rounded shadow">
                        <div class="card-body">
                            <form id="form">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-custom" id="checkBtn">Check</button>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        $.each(response, function(i, val) {
                            $('#resultBody').append(`
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-custom select-service" data-service="${val.service}" data-cost="${val.cost[0].value}">Select</button>
                                    </td>
                                </tr>
                            `);
                        });
